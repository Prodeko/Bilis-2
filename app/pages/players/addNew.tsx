  ...
  return (
    <form className="w-full flex align-center py-20 justify-center" onSubmit={handleSubmit}>
      ...
      <h2 className='p-8'>Lisää pelaaja</h2>
        <FormInput value={player.firstName} handleChange={setKey("firstName")} placeholder="Etunimi" />
        <FormInput value={player.lastName} handleChange={setKey("lastName")} placeholder="Sukunimi" />
        ...
        <FormInput value={player.favoriteColor} handleChange={setKey("favoriteColor")} placeholder="Lemppari väri" />
        <button className='w-full bg-prodekoBlue h-24 text-white text-2xl'>
          Luo pelaaja
        </button>
