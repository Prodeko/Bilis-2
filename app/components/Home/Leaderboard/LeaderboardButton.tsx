...
const LeaderboardButton: NextPage<Props> = ({ setAllTimeSelected, allTimeSelected, allTimeText, seasonalText }) => {
  ...
  return (
    <div className="relative">
      <div className='flex absolute -translate-y-9 gap-1 text-lg pl-[0.5rem]'>
        <button className={`${buttonProperties} ${allTimeSelected ? active : disabled}`}
