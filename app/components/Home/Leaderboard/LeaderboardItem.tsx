...
const LeaderboardItem: NextPage = () => {
  return(
    <div className='bg-white m-4 shadow-xl hover:scale-[1.01] px-8 py-4 rounded-md flex items-center justify-between gap-5 hover:cursor-pointer transition-all'>
      <div>1.</div>
