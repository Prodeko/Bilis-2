...
const RecentGame = ({ game }: {game: GameListItem}) => {
  ...
  return (
    <Card>
      ...
      <div style={{background: game.winner.favoriteColor}} className={`shadow-l w-8 h-8 py-4 rounded-full flex justify-center items-center text-xl`}>
        {loserEmoji}
      </div>
      ...
      <div style={{background: game.loser.favoriteColor}} className={`shadow-l w-8 h-8 py-4 rounded-full flex justify-center items-center text-xl`}>
        {winnerEmoji}  
      </div>
